...
class Entry(db.Model):
  ...
  answer1 = db.Column(db.String(3))
  answer2 = db.Column(db.String(3))
  answer3 = db.Column(db.String(3))
  answer4 = db.Column(db.String(3))
  answer5 = db.Column(db.String(3))
  answer6 = db.Column(db.String(3))
  answer7 = db.Column(db.String(3))
  answer8 = db.Column(db.String(3))
  answer9 = db.Column(db.String(3))
  answer10 = db.Column(db.String(3))
  answer11 = db.Column(db.String(3))
  answer12 = db.Column(db.String(3))
  answer13 = db.Column(db.String(3))
  answer14 = db.Column(db.String(3))
  answer15 = db.Column(db.String(3))
  answer16 = db.Column(db.String(3))
  answer17 = db.Column(db.String(3))
  answer18 = db.Column(db.String(3))
  answer19 = db.Column(db.String(3))
  answer20 = db.Column(db.String(3))
  answer21 = db.Column(db.String(3))
  answer22 = db.Column(db.String(3))
  answer23 = db.Column(db.String(3))
  answer24 = db.Column(db.String(3))
  answer25 = db.Column(db.String(3))
  answer26 = db.Column(db.String(3))
  answer27 = db.Column(db.String(3))
  answer28 = db.Column(db.String(3))
  answer29 = db.Column(db.String(3))
  answer30 = db.Column(db.String(3))
  answer31 = db.Column(db.String(3))
  answer32 = db.Column(db.String(3))
